...
\fancyhead[L]{Seminar 1 -- 1DV720 -- Server Administration} % Titel till vänster i sidhuvud
    ...
    \subsection{General}
        ...
        \item There are a lot of different Linux distributions, choose three of the major distributions and answer the following questions:
            \begin{enumerate}[a.]
                ...
                \item Why did you choose these distributions?
            \end{enumerate}
