...
\begin{enumerate}
    ...
    \subsection{General}
        ...
        \item Windows Powershell and Windows Command Prompt
            ...
            \end{enumerate}
        \item How dose Windows Advanced Firewall work?
        ...
        \item IPTables
            \begin{enumerate}[a.]
                ...
                \item What dose the following command do:
                \newline
                {\color{red}Du får gärna byta ut kommandot mot något som de lär sig mer av}
                \newline
                \lstinline[style=BashInputStyle]"sudo iptables -A INPUT -m conntrack --ctstate ESTABLISHED,RELATED -j ACCEPT" 

                \item {\color{red}Lägg gärna till fler frågor om IPTables}
            \end{enumerate}
        \item What dose the following Bash tools do and how do you use them:
            \begin{enumerate}[a.]
                \item sudo
                \item touch
                \item {\color{red}Lägg till de verktyg som du tycker är viktiga att kunna så här i början av kursen.}
            \end{enumerate}
        \item {\color{red}Vad har jag glömt? Lägg gärna till fler frågor.}
    \end{large}
\end{enumerate}
\end{document}
