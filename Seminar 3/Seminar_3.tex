...
\fancyhead[L]{Seminarie 1 -- 1DV416 -- HT13 -- Windowsadministraion I} % Titel till vänster i sidhuvud
...
\title{	\vspace{-10cm}
    ...
    \huge Seminarie 1\\ % Arbetes titel
...
Under detta seminarium kommer vi att behandla följande ämnen:
\begin{itemize}
\item Server vs. Klient
\item Installation av Windows Server
\item Post Setup för Windows Server
\item Grundläggande konfiguration
\item Administrationsverktyg 
...
%------------------------------------------------
\section{Dealine}
Seminariet är den {\color{red}21:e november 2013} och det är obligatorisk närvaro.
