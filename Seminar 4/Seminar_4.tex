...
\fancyhead[L]{Seminarie 3 -- 1DV416 -- HT13 -- Windowsadministraion I} % Titel till vänster i sidhuvud
...
\title{	\vspace{-10cm}
    ...
    \huge Seminarie 3\\ % Arbetes titel
...
Under detta seminarium kommer vi att behandla katalogtjänster i allmänhet och Active Directory i synnerhet. Vi kommer att titta närmar på följande ämnen:
\begin{itemize}
\item Katalogtjänster
\item Active Directory
	\begin{itemize}
    	\item Översikt
	\item DNS
	\item Globala katalogen
	\item Organisationsenheter
	\item Användarkonton
	\item Grupper
	\item Profiler	\item FSMO roller	\item RODC	\item Delegering av administration
	\end{itemize}
\end{itemize}
...
%------------------------------------------------
\section{Dealine}
Seminariet är den {\color{red}12:e december 2013} och det är obligatorisk närvaro.
